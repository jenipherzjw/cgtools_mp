...
#		
#------------------------------------------------------------#
# This script is for running a CG membrane-peptide interactions 
# simulations with Espresson MD 
#
# Implements settings contained in a parameter file should be
...
::mmsg::send $this "               ***********************  "
::mmsg::send $this "              *                       * "
::mmsg::send $this "              *     MEMBRENE-PEPTIDE  * "
::mmsg::send $this "              *       ZUNJING WANG    * "
::mmsg::send $this "              *       (2010-2014)     * "
::mmsg::send $this "              *                       * "
::mmsg::send $this "               ***********************  "
::mmsg::send $this ""
...
\t-hp_medium \t\t set a hydrophobic environement
