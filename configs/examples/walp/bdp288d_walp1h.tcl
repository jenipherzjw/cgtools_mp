...
#
# 288 DPPC liquid-gel coexistent bilayer with walp23 helix.
#
...
set lipidfile "dppcbilayer_288.domain.vmd0049.crd"

# peptide input file
#set numberofpeptide 4 
#set peptidefile  "walp23_4.init.crd"
set numberofpeptide 1 
#set peptidefile  "walphelix.cap.288domain.init.crd"
set peptidefile  "walphelix.cap.288domain.m1.crd"
...
set warmup_temp 0.985826896977
set warmup_freq 5
set warmsteps 50
set warmtimes 20
