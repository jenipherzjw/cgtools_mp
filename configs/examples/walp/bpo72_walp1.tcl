...
set lipidfile "bilayer72_walp1m5.vmd1102.popc.crd"

# peptide input file
#set numberofpeptide 4 
#set peptidefile  "walp23_4.init.crd"
set numberofpeptide 1 
set peptidefile  "bilayer72_walp1m5.vmd1102.walp.crd"
...
set ident "bilayer[set numberoflipid]_walp[set numberofpeptide]"
...
set fix_time_step 10

# -------- Set the espresso integration steps and times 
# The number of steps to integrate with each call to integrate $1\tau \sim 0.1ps$ thus 100000x0.01\tau=0.05ns
set int_steps   50000
...
#set replica_temps { 1.0 1.05 1.1 1.15 1.2}
...
# backup frequency  0.05ns
set write_frequency 50
# analysis frequency 0.05ns
set analysis_write_frequency 50
