...
set beadtypelist [list {8 N 14.00 0} {9 CA 12.00 0} {10 NP 14.00 0} {11 C 12.00 0} {12 O 16.00 0} {13 XX 1. 0} {14 XX 1. 0}  {15 N 14.00 0} {16 C 12.00 0} {17 XX 1. 0} {18 XX 1. 0} {19 XX 1. 0} {20 CB 75.0 0 GLY} {21 CB  89. 0 ALA} {22 CB 115.0 0 PRO} {23 CB 147.0 -1 GLU} {24 CB  146.0 0 GLN} {25 CB 133.0 -1 ASP} {26 CB 132.0 0 ASN} {27 CB 105.0 0 SER} {28 CB 155.0 0 HIS} {29 CB 146.0 1 LYS} {30 CB 174.0 1 ARG} {31 CB 119.0 0 THR} {32 CB 117.0 0 VAL} {33 CB 131.0 0 ILE} {34 CB 131.0 0 LEU} {35 CB 149.0 0 MET} {36 CB 165.0 0 PHE} {37 CB 181.0 0 TYR} {38 CB 121.0 0 CYS} {39 CB 204.0 0 TRP} {40 CB 75.0 0 CAP} {41 CB 147.0 0 GUN} {42 CB 133.0 0 APN} {43 CB 146.0 0 LSN} {44 CB 174.0 0 AGN} ]
...
set partlist_per_res3letter [list {GLY { 8 9 20 11 12}}\
				{ALA { 8 9 21 11 12}}\
				{PRO {10 9 22 11 12}}\
				{GLU { 8 9 23 11 12}}\
				{GLN { 8 9 24 11 12}}\
...
# Source interaction parameters
source peptideb/peptide_parameters.tcl
source peptideb/peptide_sc_parameters.tcl
...
foreach name $peptideb::3letter_list {
    # No interaction with Gly (20) and terminal END (40)
    if {$name != "GLY"} {
...
proc aa_lipid_inter { aa_num } {
	...
	21 { # ala
	    ...
	    return [list { "lj" 1.2 6.41 } { "wca" 1.0 7.69 } \
			    { "lj" 7.5 4.0 } { "wca" 1.0 2.48 } \
			    { "wca" 1.0 4.0 } { "wca" 1.0 9.14 }]
	} 42 { # asp0 -- APN
...
for { set cb_type 20 } { $cb_type < 45 } { incr cb_type } {
	...
	foreach type [lindex $lipid_beads $bead_type] {	    
		...
		lappend nb_interactions [list $type $cb_type lennard-jones \
					     $inter_eps $inter_sig $lj_cutoff \
					     [calc_lj_shift $inter_sig $lj_cutoff] $lj_offset]
	    } elseif { $inter_type == "wca" } {
		lappend nb_interactions [list $type $cb_type lennard-jones \
					     $inter_eps $inter_sig [expr 1.12246*$inter_sig] \
					     0.25 $lj_offset ]
