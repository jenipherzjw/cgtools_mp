namespace eval peptideb {
    ...
    #variable eps 1.0
    ## lipid T0=310K, peptide T0=300K
    variable eps 0.96774
    ...
    if {[info exists cgtools::hp_medium] && $cgtools::hp_medium==1} {
    ...
    #puts "cgtools::hp_medium: $cgtools::hp_medium"
    #puts "ljangle_eps: $ljangle_eps"
    #exit
    ...
    if {![info exists cgtools::HB_bilayer_z0]} {
	variable HB_bilayer_z0 0. }
    if {![info exists cgtools::HB_bilayer_dz]} {
	variable HB_bilayer_dz 0. }
    if {![info exists cgtools::HB_bilayer_kappa]} {
	variable HB_bilayer_kappa 1. }

    # Hat potential to compensate for bilayer
    if {![info exists cgtools::hat_potential]} {
