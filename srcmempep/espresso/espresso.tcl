...
namespace eval cgtools {
	...
	proc espresso_init { } {
		...
		# See if there is any fixed molecules of lipids
		...
		#----------------------------------------------------------#
		# Warm up containing fixed particles of lipids
		...
		# Warm up without any fixed particle of lipids
		...
		# ----------- Integration Parameters after unfix lipids -----------#
		# Setup analysis
	    ...
	    thermostat langevin $cgtools::systemtemp $cgtools::langevin_gamma
            ...
            # Fist fix peptide, only simulate membrane, then unfix peptide and reset time step after $cgtools::fix_time_step
	    #----------------------------------------------------------#
